package com.example.ppe3_bts.myrequest;
...
public class Myrequest {
    ...
    public  void register(final String nom, final String password, final String password2, RegisterCallback callback){

        String url = "http://localhost/ppe3bts/Inscription.php";
